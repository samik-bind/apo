...
const { test: check, describe } = task("code-review", {
...
describe("trajectory", "Trajectory — multi-file review, ordered tool use", () => {
...
describe("facts", "Objective facts — known issues identified", () => {
...
describe("judges", "Judged quality — grounding, specificity, edge cases", () => {
